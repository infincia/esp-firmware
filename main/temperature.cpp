...
void Temperature::start() {
    ...
    xTaskCreate(&task_wrapper, "temperature_task", 2048, this, (tskIDLE_PRIORITY + 10),
...
bool Temperature::update() {
...
#if defined(CONFIG_FIRMWARE_USE_WEB)
    {
        ...
        ESP_LOGI(TAG, "sending temperature reading to web task");
...
#if defined(CONFIG_FIRMWARE_USE_AWS) || defined(CONFIG_FIRMWARE_USE_HOMEKIT)
    {
        ...
        ESP_LOGI(TAG, "sending temperature reading to aws task");
        ...
        ESP_LOGI(TAG, "sending temperature reading to homekit task");
