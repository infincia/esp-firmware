...
void OLED::start() {
    ...
    SSD1306_FontDrawAnchoredString(&this->I2CDisplay, TextAnchor_SouthWest, v->version, SSD_COLOR_WHITE);

    SSD1306_Update(&this->I2CDisplay);

    SSD1306_SetFont(&this->I2CDisplay, &Font_Tarable7Seg_32x64);

    xTaskCreate(&task_wrapper, "oled_task", 3072, this, (tskIDLE_PRIORITY + 10), &this->oled_task_handle);
}
